...
namespace NotificationMS.Infrastructure.Database.Context.Mongo
{
    ...
    public class ApplicationDbContextMongo : IApplicationDbContextMongo
    {
        ...
        public IMongoCollection<Notification> Notifications => _database.GetCollection<Notification>("Categories");
